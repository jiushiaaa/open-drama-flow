...
export function getSeedanceCapabilityProfile(settings = {}) {
  ...
  return {
    ...
    generateAudio: profile.recognized,
    defaultGenerateAudio: Boolean(settings.generateAudio),
    nativeAudio: { supported: profile.recognized, defaultEnabled: Boolean(settings.generateAudio), requestParameter: "generate_audio", shotOverride: "audioMode=provider-native", entitlementVerified: false },
