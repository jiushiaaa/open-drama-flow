...
当用户想复用一套“双人合作游戏主菜单 / 开场动画”制作流程时使用本 Skill。流程会收集玩家信息、游戏标题、视觉风格和可选角色参考图；先生成一张确认首图，等待用户批准后，再创建最终 旧 H3 视频提示词与视频方案。
...
- “帮我做一个双人游戏主菜单开场视频。”
- “Use 旧 H3 to create a two-player game menu animation.”
