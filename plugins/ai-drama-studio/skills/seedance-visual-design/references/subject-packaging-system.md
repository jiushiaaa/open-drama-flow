...
When the subject is a speaker or the user wants voice-led packaging, keep identity, face, mouth, hands, performance, framing and original audio. The final visual package must be generated by Seedance 2.5; transcription supplies exact words and timing only, never the visual result.
...
Use these fragments inside the main Seedance 2.5 prompt:
