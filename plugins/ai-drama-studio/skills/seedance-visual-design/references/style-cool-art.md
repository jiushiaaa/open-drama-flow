...
## 8. 可直接写入 Seedance 2.5 执行提示词 的锁定块
...
从用户上传的暗黑 Seedance 2.5 参考中内化径向红线聚字、横向扫描条、中心人物与后景大字、一次黑白反相、局部微距、裂隙光与单侧粒子剥离。所有参考只提供机制和审美校准，不复制其中品牌、人物、Logo、广告卖点、水印或原文案。
