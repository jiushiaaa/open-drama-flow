...
The default route remains 旧 MiniMax H3. An explicitly selected other model is an execution choice, never a required or preferred model. Do not preconfigure a named alternative or add a named alternative to option cards.
