# Seedance 2.5 Video Prompting Guide

Use this guide when Seedance 2.5 is the selected creative model family. Confirm current input modes, sound support, clip limits, and delivery formats at execution time.
