...
3. **Sound mood** — a brief for Seedance native sound or selection of existing authorized music, not a callable independent music model. Stock-voice TTS/ASR follow the optional configured Doubao speech route.
