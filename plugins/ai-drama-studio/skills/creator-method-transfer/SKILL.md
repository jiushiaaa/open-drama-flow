...
用户要求借鉴Hell Grind、复盘旧实验或验证短攻防/音点时，读[方法迁入与证据边界](references/hell-grind-transfer.md)。沿用现有ShotSpec与producer工具，不另起外部生产系统。
...
本批博主灯光/POV/长镜头与注意力资料，读[导演方法与技术说法](references/prompt-claims-and-directing.md)，再按需读取其中链接的灯光调度规则。
