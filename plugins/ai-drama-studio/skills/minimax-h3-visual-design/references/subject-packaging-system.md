...
When the subject is a speaker or the user wants voice-led packaging, keep identity, face, mouth, hands, performance, framing and original audio. The final visual package must be generated by 旧 MiniMax H3; transcription supplies exact words and timing only, never the visual result.
...
Use these fragments inside the main 旧 H3 prompt:
