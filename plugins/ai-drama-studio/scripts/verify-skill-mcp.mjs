...
try {
  ...
  for (const name of ["drama_edit_local_media", "drama_process_local_audio", "drama_compare_local_edits", "drama_prepare_audio_event_evidence"]) assert.ok(exposed.has(name), name);
